...
const DashboardPage = async ({ searchParams }: DashboardPageProps) => {
  ...
  // Transformar todayAppointments para o formato esperado pela DataTable
  const transformedTodayAppointments = todayAppointments.map((appointment) => ({
    id: appointment.id,
  ...
  return (
    <PageContainer>
      ...
      <PageContent>
        ...
        {/* Middle Row - Chart and Top Doctors */}
        <div className="grid grid-cols-[2.25fr_1fr] gap-4">
          <AppointmentsChart dailyAppointmentsData={dailyAppointmentsData} />
          <TopDoctors doctors={topDoctors} />
        </div>
        
        {/* Bottom Row - Appointments Table and Top Specialties */}
        <div className="grid grid-cols-[2.25fr_1fr] gap-4">
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <DataTable
                ...
                data={transformedTodayAppointments}
              />
            </CardContent>
          </Card>
